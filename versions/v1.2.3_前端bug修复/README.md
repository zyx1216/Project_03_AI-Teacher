...
面向**单人中小学教师**本地运行的 AI 辅助教学工具，集备课、作业、学情分析于一体；底层支持 9 个学科，v1.2.3 起界面标题固定为“AI教学辅助”、学科切换暂时下线（当前固定数学）。
...
| `utils/app_config.py` | 当前学科配置（9 学科能力保留，写入 data/app_config.json；v1.2.3 起界面固定数学） |
